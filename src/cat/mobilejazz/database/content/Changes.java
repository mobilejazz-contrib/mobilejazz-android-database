...
public class Changes implements BaseColumns {
		...
		/**
		 * Column name for the id of the affected object.
		 * <p>
		 * Type: INTEGER
		 * </p>
		 */
		...
		/**
		 * Column name for the changed values. This should already be prepared
		 * in a way, that the server can understand it.
		 * <p>
